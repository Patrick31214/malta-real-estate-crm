  ...
  return (
    <ResponsiveContainer width="100%" height={210}>
      <BarChart data={data} margin={{ top: 4, right: 8, bottom: 4, left: -20 }}>
        ...
        <XAxis dataKey="name" tick={{ fontSize: 12, fill: '#c4a882' }} />
      ...
      <div className="dashboard">
        ...
        <section className="dash-section">
          ...
          <div className="dash-cards-row">
            ...
            <StatCard icon={Home}         label="Long Lets"      value={longLetProps.length}  linkTo="/properties" accent="#6B5040" sub={fmtEur(longLetRevenue)} />
        ...
        <section className="dash-section">
          ...
          <div className="dash-cards-row">
            ...
            <StatCard icon={Bot}       label="AI Automated Contacts" value={aiStats.totalAI}         linkTo="/owners" accent="#7A5C3A" />
