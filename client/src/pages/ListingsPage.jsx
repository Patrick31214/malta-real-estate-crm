      ...
      <div className="listing-body">
        ...
        {p.agent && (
          <div className="listing-agent">
            ...
            {(p.agent.mobile || p.agent.phone) && (
              <a
                href={`https://wa.me/${(p.agent.mobile || p.agent.phone).replace(/\D/g, '')}?text=${encodeURIComponent(`Hi, I'm interested in the property: ${p.title} - €${Number(p.price).toLocaleString()} (${p.city || p.address || 'Malta'}). Please provide more details.`)}`}
                className="listing-whatsapp-btn"
                target="_blank"
      ...
      <header className="listings-header">
        <div className="listings-header-inner">
          ...
          <div className="listings-header-actions">
            <button
              className="listings-theme-toggle"
              onClick={toggleTheme}
