      ...
      <div className="listing-body">
        ...
        {p.agent && (
          <div className="listing-agent">
            ...
            {(p.agent.mobile || p.agent.phone) && (
              (() => {
                const phone = (p.agent.mobile || p.agent.phone).replace(/\D/g, '');
                const message = `Hi, I'm interested in the property: ${p.title} - €${Number(p.price).toLocaleString()} (${p.city || p.address || 'Malta'}). Please provide more details.`;
